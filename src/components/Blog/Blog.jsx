...
const Blog = ({blog, handleAddToBookmark, handleAddToReadTime}) => {
    const {id, cover, author_img, author, title, posted_date, reading_time, hashtags} =blog
    return (
        <div className='space-y-4 mb-5'>
            ...
            <button onClick={() =>handleAddToReadTime(id,reading_time)} className='text-purple-700 underline cursor-pointer font-semibold'>Mark as Read</button>
        </div>
    );
};
